          ...
          <div className="v2projects-box-display">
            ...
            <div className="v2projects-box-right" data-aos="fade-down">
              <div className="v2projects-box-right-item">
                ...
                <p>Are you hungry?</p>
                <p>
                  Online food ordering application. The food list is available
                  from an API built using Node and Express, while the front-end
                  is built with React. The database used is Mongodb.
                </p>
                <h4>made with</h4>
                <div className="v2projects-box-right-item-icon">
                  <div className="v2projects-box-right-item-icon-item">
                    <div className="v2projects-box-right-item-icon-item-svg">
                      <svg
                ...
                <a href="https://github.com/hoggir/eduwork-studikasus-frontend">
                  GITHUB
                </a>
              </div>
            </div>
          ...
          <div className="v2projects-box-display-reverse">
            <div className="v2projects-box-right" data-aos="fade-down">
              <div className="v2projects-box-right-item-reverse">
                ...
                <p>
                  Rest API for OnFood applications. Built with Node, Express and
                  Mongodb. Using Json Web Token for authentication.
                </p>
                <h4>made with</h4>
                <div className="v2projects-box-right-item-icon-reverse">
                  <div className="v2projects-box-right-item-icon-item">
                    <div className="v2projects-box-right-item-icon-item-svg">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://github.com/hoggir/eduwork-studikasus-backend">
                  GITHUB
                </a>
              </div>
            </div>
        ...
        <div className="pd-30 v2projects-box">
          <div className="v2projects-box-display">
            ...
            <div className="v2projects-box-right" data-aos="fade-down">
              <div className="v2projects-box-right-item">
                <h3>Landing Page</h3>
                <p>Looking for web programmers?</p>
                <p>
                  Landing page to promote myself. Made using EmailJS to send
                  emails to me.
                </p>
                <h4>made with</h4>
                <div className="v2projects-box-right-item-icon">
                ...
                <a href="https://fdportofolio.herokuapp.com/landingpage">
                  DEMO
                </a>
              </div>
            </div>
